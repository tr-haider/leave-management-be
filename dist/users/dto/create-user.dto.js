...
const is_less_than_or_equal_validator_1 = require("../validators/is-less-than-or-equal.validator");
class CreateUserDto {
    name;
    email;
    password;
...
], CreateUserDto.prototype, "totalLeaves", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, default: 0 }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, is_less_than_or_equal_validator_1.IsLessThanOrEqual)('totalLeaves', {
        message: 'Availed leaves cannot be greater than total leaves',
    }),
    __metadata("design:type", Number)
], CreateUserDto.prototype, "availedLeaves", void 0);
